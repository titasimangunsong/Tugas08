...
public class KelolaMahasiswaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv.setAdapter(new ArrayAdapter<String>(KelolaMahasiswaActivity.this, android.R.layout.simple_list_item_1, mhs));
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) { //int i untuk tau urutan item
                Toast.makeText(KelolaMahasiswaActivity.this, "Anda memilih " + mhs[i], Toast.LENGTH_SHORT).show(); //length short durasi krg lbh 2 dtk
    ...
    private View.OnClickListener addMhsButtonListener = new View.OnClickListener(){
        ...
        public void onClick(View view){
            Intent intent = new Intent(KelolaMahasiswaActivity.this,MahasiswaAddActivity.class);
    ...
    private View.OnClickListener editMhsButtonListener = new View.OnClickListener(){
        @Override
        public void onClick(View view){
            Intent intent = new Intent(KelolaMahasiswaActivity.this,MahasiswaEditActivity.class);
            startActivity(intent);
        }
    };
}
